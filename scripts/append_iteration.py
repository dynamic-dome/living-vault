...
- **infra** — Neuer GitHub-Remote: https://github.com/dynamic-dome/living-vault (privat). 43 Commits gepushed. CLAUDE.md-Konvention `living-vault | Phase-{N}: ...` durchgehalten — `git log --grep="living-vault"` ist damit der Handoff-Index fuer naechste Sessions.
